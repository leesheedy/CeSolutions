...
function LocationPage(){
  ...
  return <><Header/><main id="main">
    ...
    <section className="loc-areas wrap" aria-labelledby="loc-areas-heading"><Kicker>Areas we cover</Kicker><h2 id="loc-areas-heading">Around {l.name}</h2><ul className="loc-areas__list">{l.suburbs.map(s=><li key={s}>{s}</li>)}</ul><p>Somewhere nearby that isn’t listed? Send your address with the form below and Ella will confirm.</p></section>
    <QuoteBand/>
